...
from face_msg.msg import Roilist 
...
class FaceDetect(Node):
    def __init__(self):
        ...
        self.pub = self.create_publisher(Roilist, "face_detect/roi", 1)
    ...
    def detect_and_draw(self,imgmsg):
        ...
        for (x, y, w, h) in faces:
            ...
            roi.height = int(h)
            roi.width = int(w)
            roi.do_rectify = False  #we put it as false to begin with
            roilist.regions.append(roi)
