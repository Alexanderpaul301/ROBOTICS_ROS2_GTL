...
bool cs7630_msgs__msg__roi_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cs7630_msgs.msg._roi_array.ROIArray", full_classname_dest, 35) == 0);
  }
  cs7630_msgs__msg__ROIArray * ros_message = _ros_message;
  {  // header
  ...
  {  // rois
    ...
    sensor_msgs__msg__RegionOfInterest * dest = ros_message->rois.data;
...
PyObject * cs7630_msgs__msg__roi_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cs7630_msgs.msg._roi_array");
