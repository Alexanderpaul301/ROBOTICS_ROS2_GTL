...
#include "cs7630_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const cs7630_msgs::msg::TrajectoryElement &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  cs7630_msgs::msg::TrajectoryElement &);
size_t get_serialized_size(
  const cs7630_msgs::msg::TrajectoryElement &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const cs7630_msgs::msg::Trajectory & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: ts
  {
    ...
    for (size_t i = 0; i < size; i++) {
      cs7630_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.ts[i],
        cdr);
    }
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cs7630_msgs::msg::Trajectory & ros_message)
{
  // Member: header
  ...
  // Member: ts
  {
    ...
    ros_message.ts.resize(size);
    for (size_t i = 0; i < size; i++) {
      cs7630_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.ts[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: ts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        cs7630_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.ts[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: ts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cs7630_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrajectoryElement(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = cs7630_msgs::msg::Trajectory;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cs7630_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cs7630_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
{
  return &cs7630_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cs7630_msgs, msg, Trajectory)() {
  return &cs7630_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
