...
#include "cs7630_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "cs7630_msgs/msg/detail/trajectory_element__functions.h"  // ts
...
using _Trajectory__ros_msg_type = cs7630_msgs__msg__Trajectory;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: ts
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, cs7630_msgs, msg, TrajectoryElement
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: ts
  {
    ...
    if (ros_message->ts.data) {
      cs7630_msgs__msg__TrajectoryElement__Sequence__fini(&ros_message->ts);
    }
    if (!cs7630_msgs__msg__TrajectoryElement__Sequence__init(&ros_message->ts, size)) {
      fprintf(stderr, "failed to create array for field 'ts'");
      return false;
    }
    auto array_ptr = ros_message->ts.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  size_t current_alignment)
{
  ...
  // field.name ts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_cs7630_msgs__msg__TrajectoryElement(
...
static uint32_t _Trajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cs7630_msgs__msg__Trajectory(
  ...
  size_t current_alignment)
{
  ...
  // member: ts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cs7630_msgs__msg__TrajectoryElement(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = cs7630_msgs__msg__Trajectory;
    is_plain =
      (
...
static size_t _Trajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cs7630_msgs__msg__Trajectory(
