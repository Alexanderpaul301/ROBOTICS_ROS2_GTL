...
#include "cs7630_msgs/msg/detail/trajectory_element__rosidl_typesupport_fastrtps_c.h"
...
using _TrajectoryElement__ros_msg_type = cs7630_msgs__msg__TrajectoryElement;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrajectoryElement__ros_msg_type * ros_message = static_cast<const _TrajectoryElement__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TrajectoryElement__ros_msg_type * ros_message = static_cast<_TrajectoryElement__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _TrajectoryElement__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cs7630_msgs__msg__TrajectoryElement(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cs7630_msgs__msg__TrajectoryElement;
    is_plain =
      (
...
static size_t _TrajectoryElement__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cs7630_msgs__msg__TrajectoryElement(
...
static message_type_support_callbacks_t __callbacks_TrajectoryElement = {
  "cs7630_msgs::msg",
  "TrajectoryElement",
...
static rosidl_message_type_support_t _TrajectoryElement__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrajectoryElement,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cs7630_msgs, msg, TrajectoryElement)() {
  return &_TrajectoryElement__type_support;
}
