...
namespace floor_nav {
    struct TaskGoToPoseConfig : public TaskConfig {
        TaskGoToPoseConfig() {
            ...
            define("dist_threshold",  0.5,"Distance at which a the target is considered reached",false, dist_threshold);
            define("angle_threshold",  0.4,"Angle at which a the target is considered reached",false, angle_threshold);
